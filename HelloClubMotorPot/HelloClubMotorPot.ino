...
static const int g_pinPWMLeft = 5;
static const int g_pinPWMRight = 4;
static const int g_pinDirectionLeft = 0;
static const int g_pinDirectionRight = 2;
...
void loop() {
	...
	analogWrite(g_pinPWMLeft, 1023*rA0);
	analogWrite(g_pinPWMRight, 1023*(1.0-rA0));
}
